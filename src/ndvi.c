/*
NAME:		add.c 
DESCRIPTION: 	Calculate normalised difference vegetation index (ndvi)
AUTHOR:	 	Will Grey
VERSION:	2015-11-09	
...
{	
 ...
 for(x = 0; x < PIXELS; x++)
   *(outImg + x) = (*(inImg1 + x) - *(inImg2 + x)) / (*(inImg1 + x) + *(inImg2 + x));
